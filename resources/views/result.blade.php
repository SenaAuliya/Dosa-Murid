...
<body class="animated-background overflow-auto">
    ...
    <div class="mt-4 bg-black text-orange-500 rounded-xl p-4 container mx-auto">
        ...
        <div class="mb-4">
            ...
            <input type="date" id="tanggal" name="tanggal"
                class="bg-orange-50 border border-orange-300 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
        </div>
        <div class="mb-4">
    ...
    <button type="submit"
        class="text-white bg-orange-500 hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center ">Catat
        Pelanggaran</button>
    </form>
</div>
@endif
